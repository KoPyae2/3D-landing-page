...
export default function Scene() {
    ...
    useGSAP(() => {
        ...
        if (window.scrollY < 20) {
            introTl
                .from(can1GroupRef.current.position, { y: -3, x: 1 }, 0)
                .from(can1GroupRef.current.rotation, { y: -3, x: 1 }, 0)
                .from(can2GroupRef.current.position, { y: 3, x: 1 }, 0)
                .from(can2GroupRef.current.rotation, { y: -3, x: 1 }, 0);
        }
