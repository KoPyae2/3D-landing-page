...
export default function Carousel() {
    ...
    const changeFlavour = (index: number) => {
    ...
    return (
        <section className='carousel relative grid h-screen grid-rows-[auto,4fr,auto] justify-center overflow-hidden bg-white py-12 text-white'>
            ...
            <h2 className='relative text-center text-5xl font-bold'>Choose Your Falvour</h2>
            <div className="grid grid-cols-[auto,auto,auto] items-center">
                ...
                <View className='aspect-square h-[70vmin] min-h-40' >
                    ...
                    <Environment files="/hdrs/lobby.hdr" environmentIntensity={1.5} environmentRotation={[0, 3, 3]} />
